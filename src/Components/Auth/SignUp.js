      ...
      <div className="card">
        <div className="card-content">
          <div className="column is-narrow">
            <SocialSignInText>Enter your Confirmation Code</SocialSignInText>
            <div className="field">
...
function SignUpForm(props) {
  const onSubmit = async () => {
    ...
    if (res === "UsernameExistsException") {
      props.form.setError("username", "incorrect", "Email already exists");
    }
  };
              ...
              <form onSubmit={props.form.handleSubmit(onSubmit)}>
                <div className="field">
                  ...
                  <div className="control">
                    <input
                      className={`input ${
                        props.form.errors.name ? "is-danger" : "is-info"
                      }`}
                ...
                <div className="field">
                  ...
                  <div className="control">
                    <input
                      className={`input ${
                        props.form.errors.username ? "is-danger" : "is-info"
                      }`}
                      ref={props.form.register}
                      name="username"
                      onChange={(e) => {
                    ...
                    {props.form.errors.username && (
                      <p className="help is-danger">
                        {props.form.errors.username.message}
                      </p>
                    )}
                  </div>
                </div>
                <div className="field">
                  ...
                  <div className="control">
                    <input
                      className={`input ${
                        props.form.errors.password ? "is-danger" : "is-info"
                      }`}
                      ref={props.form.register}
                      name="password"
                      type="password"
                    ...
                    {props.form.errors.password && (
                      <p className="help is-danger">
                        {props.form.errors.password.message}
                      </p>
                    )}
                  </div>
                </div>
